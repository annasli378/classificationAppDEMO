...
class MedicalApp:
    def __init__(self, root):
        ...
        self.entry_label = ttk.Label(self.left_panel, text="Enter your diagnosis:")
        self.entry_label.grid(row=2, column=0)

        self.text_entry = ttk.Entry(self.left_panel, width=30)
        ...
        self.btn_explain = ttk.Button(self.right_panel, text="EXPLAIN AI", command=self.explain, style='Green.TButton')
    ...
    def use_ai(self):
        ...
        self.message_display.config(text="AI diagnosis: ")

    def explain(self):
        # Placeholder for the explain action
        self.message_display.config(text="Explanation generated by AI for ")
